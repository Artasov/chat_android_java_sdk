...
import com.rikx.chat.databinding.ActivitySignUpBinding;
...
public class SignUpActivity extends AppCompatActivity {
    ...
    private void  signUp(){
        ...
        database.collection(Constants.KEY_COLLECTION_USERS)
                ...
                .addOnSuccessListener(documentReference -> {
                    ...
                    preferenceManager.pytString(Constants.KEY_USER_ID,documentReference.getId());
                    preferenceManager.pytString(Constants.KEY_NAME,binding.inputName.getText().toString());
                    preferenceManager.pytString(Constants.KEY_IMAGE,encodedImage);
    ...
    private Boolean isValidSignUpDetails() {
        if (encodedImage == null) {
            showToast("Загрузите фото профиля");
            return false;
